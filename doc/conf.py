...
#lightning The name for this set of Sphinx documents.  If None, it defaults to
...
# [howto/manual]).
latex_documents = [('index', 'lightning.tex', u'lightning Documentation',
                    u'Mathieu Blondel', 'manual'), ]
