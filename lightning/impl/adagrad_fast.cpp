/* Generated by Cython 0.20.1 on Sun Nov 16 23:19:38 2014 */
 ...
 *                     j = indices[jj]
 */
      __pyx_t_16 = ((__pyx_v_scale != 0.0) != 0);
      if (__pyx_t_16) {
 ...
 */
          ...
          *__Pyx_BufPtrStrided1d(double *, __pyx_pybuffernd_g_sum.rcbuffer->pybuffer.buf, __pyx_t_19, __pyx_pybuffernd_g_sum.diminfo[0].strides) += __pyx_v_tmp;

          /* "lightning/impl/adagrad_fast.pyx":111
 *                     tmp = scale * data[jj]
 *                     g_sum[j] += tmp
 *                     g_norms[j] += tmp * tmp             # <<<<<<<<<<<<<<
 * 
 ...
 */
          ...
          *__Pyx_BufPtrStrided1d(double *, __pyx_pybuffernd_g_norms.rcbuffer->pybuffer.buf, __pyx_t_20, __pyx_pybuffernd_g_norms.diminfo[0].strides) += (__pyx_v_tmp * __pyx_v_tmp);
        }
        goto __pyx_L7;
      }
      __pyx_L7:;
 ...
 * 
 */
        (__pyx_v_w[__pyx_v_j]) = __pyx_f_9lightning_4impl_12adagrad_fast__proj_elastic(__pyx_v_eta, __pyx_v_t, (*__Pyx_BufPtrStrided1d(double *, __pyx_pybuffernd_g_sum.rcbuffer->pybuffer.buf, __pyx_t_21, __pyx_pybuffernd_g_sum.diminfo[0].strides)), __pyx_v_alpha1, __pyx_v_alpha2, __pyx_v_delta, sqrt((*__Pyx_BufPtrStrided1d(double *, __pyx_pybuffernd_g_norms.rcbuffer->pybuffer.buf, __pyx_t_22, __pyx_pybuffernd_g_norms.diminfo[0].strides))));
      }
