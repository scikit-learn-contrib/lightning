/* Generated by Cython 0.20.1 on Tue Nov 25 01:42:04 2014 */
...
/* "lightning/impl/prox_sdca_fast.pyx":12
 * cimport numpy as np
 * 
 ...
 */
typedef __pyx_t_5numpy_int64_t __pyx_t_9lightning_4impl_14prox_sdca_fast_LONG;
#if CYTHON_CCOMPLEX
  #ifdef __cplusplus
...
static PyObject *__pyx_pf_9lightning_4impl_14prox_sdca_fast__prox_sdca_fit(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_self, struct __pyx_obj_9lightning_4impl_12dataset_fast_RowDataset *__pyx_v_X, PyArrayObject *__pyx_v_y, PyArrayObject *__pyx_v_coef, PyArrayObject *__pyx_v_dual_coef, double __pyx_v_alpha1, double __pyx_v_alpha2, int __pyx_v_loss_func, int __pyx_v_max_iter, double __pyx_v_tol, PyObject *__pyx_v_callback, int __pyx_v_n_calls, int __pyx_v_verbose, PyObject *__pyx_v_rng); /* proto */
...
/* "lightning/impl/prox_sdca_fast.pyx":19
 * 
 * 
 ...
 */
    ...
    /* "lightning/impl/prox_sdca_fast.pyx":33
 *         delta = update * data[jj]
 *         w_old = w[j]
 *         w[j] += delta             # <<<<<<<<<<<<<<
 *         regul[0] += delta * (2 * w_old + delta)
 ...
 */
    ...
    /* "lightning/impl/prox_sdca_fast.pyx":34
 *         w_old = w[j]
 *         w[j] += delta
 *         regul[0] += delta * (2 * w_old + delta)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "lightning/impl/prox_sdca_fast.pyx":41
 *     if v > sigma:
 *         return v - sigma
 *     elif v < -sigma:             # <<<<<<<<<<<<<<
 *         return v + sigma
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "lightning/impl/prox_sdca_fast.pyx":42
 *         return v - sigma
 *     elif v < -sigma:
 *         return v + sigma             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
  ...
  /*else*/ {
    ...
    /* "lightning/impl/prox_sdca_fast.pyx":44
 *         return v + sigma
 *     else:
 *         return 0             # <<<<<<<<<<<<<<
 * 
...
/* "lightning/impl/prox_sdca_fast.pyx":47
 * 
 * 
 ...
 */
    ...
    /* "lightning/impl/prox_sdca_fast.pyx":66
 *         v[j] += delta
 *         w[j] = _truncate(v[j], sigma)
 *         regul[0] -= v_old * w_old             # <<<<<<<<<<<<<<
 *         regul[0] += v[j] * w[j]
 ...
 */
    ...
    /* "lightning/impl/prox_sdca_fast.pyx":67
 *         w[j] = _truncate(v[j], sigma)
 *         regul[0] -= v_old * w_old
 *         regul[0] += v[j] * w[j]             # <<<<<<<<<<<<<<
 * 
...
/* "lightning/impl/prox_sdca_fast.pyx":70
 * 
 * 
...
static PyObject *__pyx_f_9lightning_4impl_14prox_sdca_fast__sqnorms(struct __pyx_obj_9lightning_4impl_12dataset_fast_RowDataset *__pyx_v_X, PyArrayObject *__pyx_v_sqnorms) {
  ...
  /* "lightning/impl/prox_sdca_fast.pyx":73
 *               np.ndarray[double, ndim=1, mode='c'] sqnorms):
 * 
 ...
 */
    ...
    for (__pyx_t_4 = 0; __pyx_t_4 < __pyx_t_3; __pyx_t_4+=1) {
      ...
      /* "lightning/impl/prox_sdca_fast.pyx":86
 *         dot = 0
 *         for jj in xrange(n_nz):
 *             dot += data[jj] * data[jj]             # <<<<<<<<<<<<<<
 *         sqnorms[i] = dot
 ...
 */
    ...
    /* "lightning/impl/prox_sdca_fast.pyx":87
 *         for jj in xrange(n_nz):
 *             dot += data[jj] * data[jj]
 *         sqnorms[i] = dot             # <<<<<<<<<<<<<<
 * 
...
/* "lightning/impl/prox_sdca_fast.pyx":90
 * 
 * 
 ...
 */
  ...
  for (__pyx_t_2 = 0; __pyx_t_2 < __pyx_t_1; __pyx_t_2+=1) {
    ...
    /* "lightning/impl/prox_sdca_fast.pyx":99
 * 
 *     for jj in xrange(n_nz):
 *         j = indices[jj]             # <<<<<<<<<<<<<<
 *         dot += w[j] * data[jj]
 ...
 */
  ...
  /* "lightning/impl/prox_sdca_fast.pyx":102
 *         dot += w[j] * data[jj]
 * 
 *     return dot             # <<<<<<<<<<<<<<
 * 
...
/* "lightning/impl/prox_sdca_fast.pyx":105
 * 
 * 
 ...
 */
    ...
    /* "lightning/impl/prox_sdca_fast.pyx":129
 *         residual = pred - y
 *         loss = 0.5 * residual * residual
 *         update = -(dcoef_old + residual) / (1 + sqnorm * scale)             # <<<<<<<<<<<<<<
 *         dual[0] += update * (y - dcoef_old - 0.5 * update)
 ...
 */
    ...
    /* "lightning/impl/prox_sdca_fast.pyx":138
 *         update = min(1.0, update)
 *         update = max(-1.0, update)
 *         update -= dcoef_old             # <<<<<<<<<<<<<<
 *         dual[0] += y * update
 ...
 */
    ...
    /* "lightning/impl/prox_sdca_fast.pyx":147
 *         update = min(1.0, update)
 *         update = max(0.0, update)
 *         update = y * update - dcoef_old             # <<<<<<<<<<<<<<
 *         dual[0] += y * update
 ...
 */
    ...
    /* "lightning/impl/prox_sdca_fast.pyx":148
 *         update = max(0.0, update)
 *         update = y * update - dcoef_old
 *         dual[0] += y * update             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "lightning/impl/prox_sdca_fast.pyx":156
 *     if update != 0:
 *         dcoef[0] += update
 *         if sigma > 0:             # <<<<<<<<<<<<<<
 *             _add_elastic(data, indices, n_nz, w, v, update * scale, regul,
 ...
 */
    ...
    if (__pyx_t_5) {
      ...
      /* "lightning/impl/prox_sdca_fast.pyx":157
 *         dcoef[0] += update
 *         if sigma > 0:
 *             _add_elastic(data, indices, n_nz, w, v, update * scale, regul,             # <<<<<<<<<<<<<<
 *                          sigma)
 *         else:
 */
      __pyx_t_6 = __pyx_f_9lightning_4impl_14prox_sdca_fast__add_elastic(__pyx_v_data, __pyx_v_indices, __pyx_v_n_nz, __pyx_v_w, __pyx_v_v, (__pyx_v_update * __pyx_v_scale), __pyx_v_regul, __pyx_v_sigma); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 157; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    ...
    /*else*/ {
      ...
      /* "lightning/impl/prox_sdca_fast.pyx":160
 *                          sigma)
 *         else:
 ...
 * 
 */
      __pyx_t_6 = __pyx_f_9lightning_4impl_14prox_sdca_fast__add_l2(__pyx_v_data, __pyx_v_indices, __pyx_v_n_nz, __pyx_v_w, (__pyx_v_update * __pyx_v_scale), __pyx_v_regul); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 160; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_6);
      __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
    }
    __pyx_L4:;
...
/* "lightning/impl/prox_sdca_fast.pyx":163
 * 
 * 
...
static PyObject *__pyx_pw_9lightning_4impl_14prox_sdca_fast_1_prox_sdca_fit(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_self,&__pyx_n_s_X,&__pyx_n_s_y,&__pyx_n_s_coef,&__pyx_n_s_dual_coef,&__pyx_n_s_alpha1,&__pyx_n_s_alpha2,&__pyx_n_s_loss_func,&__pyx_n_s_max_iter,&__pyx_n_s_tol,&__pyx_n_s_callback,&__pyx_n_s_n_calls,&__pyx_n_s_verbose,&__pyx_n_s_rng,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_X)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("_prox_sdca_fit", 1, 14, 14, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 163; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_y)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_prox_sdca_fit", 1, 14, 14, 2); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 163; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_coef)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_prox_sdca_fit", 1, 14, 14, 3); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 163; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  4:
        if (likely((values[4] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_dual_coef)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_prox_sdca_fit", 1, 14, 14, 4); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 163; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  5:
        if (likely((values[5] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_alpha1)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_prox_sdca_fit", 1, 14, 14, 5); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 163; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  6:
        if (likely((values[6] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_alpha2)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_prox_sdca_fit", 1, 14, 14, 6); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 163; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  7:
        if (likely((values[7] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_loss_func)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_prox_sdca_fit", 1, 14, 14, 7); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 163; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  8:
        if (likely((values[8] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_max_iter)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_prox_sdca_fit", 1, 14, 14, 8); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 163; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  9:
        if (likely((values[9] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_tol)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_prox_sdca_fit", 1, 14, 14, 9); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 163; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case 10:
        if (likely((values[10] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_callback)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_prox_sdca_fit", 1, 14, 14, 10); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 163; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case 11:
        if (likely((values[11] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_n_calls)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_prox_sdca_fit", 1, 14, 14, 11); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 163; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case 12:
        if (likely((values[12] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_verbose)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_prox_sdca_fit", 1, 14, 14, 12); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 163; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case 13:
        if (likely((values[13] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_rng)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_prox_sdca_fit", 1, 14, 14, 13); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 163; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "_prox_sdca_fit") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 163; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    ...
    __pyx_v_alpha1 = __pyx_PyFloat_AsDouble(values[5]); if (unlikely((__pyx_v_alpha1 == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 168; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_alpha2 = __pyx_PyFloat_AsDouble(values[6]); if (unlikely((__pyx_v_alpha2 == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 169; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_loss_func = __Pyx_PyInt_As_int(values[7]); if (unlikely((__pyx_v_loss_func == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 170; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_max_iter = __Pyx_PyInt_As_int(values[8]); if (unlikely((__pyx_v_max_iter == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 171; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_tol = __pyx_PyFloat_AsDouble(values[9]); if (unlikely((__pyx_v_tol == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 172; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_callback = values[10];
    __pyx_v_n_calls = __Pyx_PyInt_As_int(values[11]); if (unlikely((__pyx_v_n_calls == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 174; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_verbose = __Pyx_PyInt_As_int(values[12]); if (unlikely((__pyx_v_verbose == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 175; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_rng = values[13];
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("_prox_sdca_fit", 1, 14, 14, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 163; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  __Pyx_AddTraceback("lightning.impl.prox_sdca_fast._prox_sdca_fit", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_X), __pyx_ptype_9lightning_4impl_12dataset_fast_RowDataset, 1, "X", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 164; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_y), __pyx_ptype_5numpy_ndarray, 1, "y", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 165; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_coef), __pyx_ptype_5numpy_ndarray, 1, "coef", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 166; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_dual_coef), __pyx_ptype_5numpy_ndarray, 1, "dual_coef", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 167; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_r = __pyx_pf_9lightning_4impl_14prox_sdca_fast__prox_sdca_fit(__pyx_self, __pyx_v_self, __pyx_v_X, __pyx_v_y, __pyx_v_coef, __pyx_v_dual_coef, __pyx_v_alpha1, __pyx_v_alpha2, __pyx_v_loss_func, __pyx_v_max_iter, __pyx_v_tol, __pyx_v_callback, __pyx_v_n_calls, __pyx_v_verbose, __pyx_v_rng);
...
static PyObject *__pyx_pf_9lightning_4impl_14prox_sdca_fast__prox_sdca_fit(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_self, struct __pyx_obj_9lightning_4impl_12dataset_fast_RowDataset *__pyx_v_X, PyArrayObject *__pyx_v_y, PyArrayObject *__pyx_v_coef, PyArrayObject *__pyx_v_dual_coef, double __pyx_v_alpha1, double __pyx_v_alpha2, int __pyx_v_loss_func, int __pyx_v_max_iter, double __pyx_v_tol, PyObject *__pyx_v_callback, int __pyx_v_n_calls, int __pyx_v_verbose, PyObject *__pyx_v_rng) {
  int __pyx_v_n_samples;
  ...
  __pyx_t_9lightning_4impl_14prox_sdca_fast_LONG __pyx_v_t;
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_y.rcbuffer->pybuffer, (PyObject*)__pyx_v_y, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 163; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_pybuffernd_y.diminfo[0].strides = __pyx_pybuffernd_y.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_y.diminfo[0].shape = __pyx_pybuffernd_y.rcbuffer->pybuffer.shape[0];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_coef.rcbuffer->pybuffer, (PyObject*)__pyx_v_coef, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 163; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_dual_coef.rcbuffer->pybuffer, (PyObject*)__pyx_v_dual_coef, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 163; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  ...
  /* "lightning/impl/prox_sdca_fast.pyx":178
 *                    rng):
 * 
 *     cdef int n_samples = X.get_n_samples()             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "lightning/impl/prox_sdca_fast.pyx":179
 * 
 *     cdef int n_samples = X.get_n_samples()
 *     cdef int n_features = X.get_n_features()             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "lightning/impl/prox_sdca_fast.pyx":184
 ...
 */
  ...
  __pyx_t_2 = __Pyx_PyInt_From_int(__pyx_v_n_samples); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 189; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  ...
  __pyx_t_6 = __Pyx_PyObject_GetAttrStr(__pyx_t_5, __pyx_n_s_float64); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 189; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_6);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  if (PyDict_SetItem(__pyx_t_2, __pyx_n_s_dtype, __pyx_t_6) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 189; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  __pyx_t_6 = __Pyx_PyObject_Call(__pyx_t_3, __pyx_t_4, __pyx_t_2); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 189; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_6);
 ...
 *     # Pointers
 */
  __pyx_t_6 = __pyx_f_9lightning_4impl_14prox_sdca_fast__sqnorms(__pyx_v_X, ((PyArrayObject *)__pyx_v_sqnorms)); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 190; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_6);
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
 ...
 */
  ...
  /* "lightning/impl/prox_sdca_fast.pyx":194
 *     # Pointers
 *     cdef double* w = <double*>coef.data
 *     cdef double* dcoef = <double*>dual_coef.data             # <<<<<<<<<<<<<<
 *     cdef np.ndarray[double, ndim=1] v_data
 ...
 */
  ...
  /* "lightning/impl/prox_sdca_fast.pyx":196
 *     cdef double* dcoef = <double*>dual_coef.data
 *     cdef np.ndarray[double, ndim=1] v_data
 *     v_data = np.zeros(n_features, dtype=np.float64)             # <<<<<<<<<<<<<<
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  __pyx_t_6 = __Pyx_PyInt_From_int(__pyx_v_n_features); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 196; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_6);
  ...
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_float64); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 196; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  if (PyDict_SetItem(__pyx_t_6, __pyx_n_s_dtype, __pyx_t_5) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 196; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_5 = __Pyx_PyObject_Call(__pyx_t_2, __pyx_t_4, __pyx_t_6); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 196; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  ...
  /* "lightning/impl/prox_sdca_fast.pyx":197
 *     cdef np.ndarray[double, ndim=1] v_data
 *     v_data = np.zeros(n_features, dtype=np.float64)
 *     cdef double* v = <double*>v_data.data             # <<<<<<<<<<<<<<
 *     cdef np.ndarray[int, ndim=1] sindices
 ...
 */
  ...
  /* "lightning/impl/prox_sdca_fast.pyx":199
 *     cdef double* v = <double*>v_data.data
 *     cdef np.ndarray[int, ndim=1] sindices
 *     sindices = np.arange(n_samples, dtype=np.int32)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_6 = __Pyx_PyObject_GetAttrStr(__pyx_t_5, __pyx_n_s_arange); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 199; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_6);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_5 = __Pyx_PyInt_From_int(__pyx_v_n_samples); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 199; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_int32); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 199; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  if (PyDict_SetItem(__pyx_t_5, __pyx_n_s_dtype, __pyx_t_3) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 199; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = __Pyx_PyObject_Call(__pyx_t_6, __pyx_t_4, __pyx_t_5); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 199; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  ...
  __pyx_t_13 = ((PyArrayObject *)__pyx_t_3);
  {
    ...
    if (unlikely(__pyx_t_8 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 199; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_t_13 = 0;
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "lightning/impl/prox_sdca_fast.pyx":207
 * 
 *     if alpha1 > 0:  # Elastic-net case
 *         sigma = alpha1 / alpha2             # <<<<<<<<<<<<<<
 *     else:  # L2-only case
 ...
 */
  ...
  /*else*/ {
    ...
    /* "lightning/impl/prox_sdca_fast.pyx":209
 *         sigma = alpha1 / alpha2
 *     else:  # L2-only case
 *         sigma = 0             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "lightning/impl/prox_sdca_fast.pyx":217
 * 
 *     t = 0
 *     for it in xrange(max_iter):             # <<<<<<<<<<<<<<
 *         primal = 0
 ...
 */
    __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_v_rng, __pyx_n_s_shuffle); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 220; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_3);
    ...
    __pyx_t_4 = __Pyx_PyObject_Call(__pyx_t_3, __pyx_t_5, NULL); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 220; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_4);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
 ...
 */
    ...
    for (__pyx_t_16 = 0; __pyx_t_16 < __pyx_t_15; __pyx_t_16+=1) {
      ...
      /* "lightning/impl/prox_sdca_fast.pyx":224
 *         for ii in xrange(n_samples):
 * 
 *             i = sindices[ii]             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      if (__pyx_t_1) {
        ...
        /* "lightning/impl/prox_sdca_fast.pyx":227
 * 
 *             if sqnorms[i] == 0:
 *                 continue             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      /* "lightning/impl/prox_sdca_fast.pyx":230
 * 
 *             # Retrieve row.
 *             X.get_row_ptr(i, &indices, &data, &n_nz)             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      /* "lightning/impl/prox_sdca_fast.pyx":232
 *             X.get_row_ptr(i, &indices, &data, &n_nz)
 * 
 *             _solve_subproblem(data, indices, n_nz, y[i], w, v, dcoef + i,             # <<<<<<<<<<<<<<
 ...
 */
      ...
      /* "lightning/impl/prox_sdca_fast.pyx":233
 * 
 *             _solve_subproblem(data, indices, n_nz, y[i], w, v, dcoef + i,
 *                               loss_func, sqnorms[i], scale, sigma, &primal,             # <<<<<<<<<<<<<<
 *                               &dual, &regul)
 ...
 */
        ...
        __pyx_t_5 = __Pyx_PyObject_Call(__pyx_v_callback, __pyx_t_4, NULL); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 237; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_5);
        __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
 ...
 */
        ...
        if (__pyx_t_1) {
          ...
          /* "lightning/impl/prox_sdca_fast.pyx":239
 *                 ret = callback(self)
 *                 if ret is not None:
 *                     break             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    if (__pyx_t_1) {
      ...
      /* "lightning/impl/prox_sdca_fast.pyx":249
 * 
 *         if verbose:
 *             print "iter", it + 1, gap             # <<<<<<<<<<<<<<
 * 
 *         if gap <= tol:
 */
      __pyx_t_5 = __Pyx_PyInt_From_long((__pyx_v_it + 1)); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 249; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_5);
      __pyx_t_4 = PyFloat_FromDouble(__pyx_v_gap); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 249; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_4);
    ...
    /* "lightning/impl/prox_sdca_fast.pyx":251
 *             print "iter", it + 1, gap
 * 
 *         if gap <= tol:             # <<<<<<<<<<<<<<
 *             if verbose:
 *                 print "Converged"
 */
    __pyx_t_1 = ((__pyx_v_gap <= __pyx_v_tol) != 0);
    if (__pyx_t_1) {
 ...
 * 
 */
        if (__Pyx_PrintOne(0, __pyx_n_s_Converged) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 253; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        goto __pyx_L13;
      }
      __pyx_L13:;

      /* "lightning/impl/prox_sdca_fast.pyx":254
 *             if verbose:
 *                 print "Converged"
 *             break             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "lightning/impl/prox_sdca_fast.pyx":258
 *     # for it in xrange(max_iter)
 * 
 *     for i in xrange(n_samples):             # <<<<<<<<<<<<<<
 *         dcoef[i] *= scale
 */
  ...
  for (__pyx_t_14 = 0; __pyx_t_14 < __pyx_t_8; __pyx_t_14+=1) {
    ...
    /* "lightning/impl/prox_sdca_fast.pyx":259
 * 
 *     for i in xrange(n_samples):
 *         dcoef[i] *= scale             # <<<<<<<<<<<<<<
 */
 ...
 *                    np.ndarray[double, ndim=1]y,
 */
  __pyx_tuple__7 = PyTuple_Pack(37, __pyx_n_s_self, __pyx_n_s_X, __pyx_n_s_y, __pyx_n_s_coef, __pyx_n_s_dual_coef, __pyx_n_s_alpha1, __pyx_n_s_alpha2, __pyx_n_s_loss_func, __pyx_n_s_max_iter, __pyx_n_s_tol, __pyx_n_s_callback, __pyx_n_s_n_calls, __pyx_n_s_verbose, __pyx_n_s_rng, __pyx_n_s_n_samples, __pyx_n_s_n_features, __pyx_n_s_sigma, __pyx_n_s_scale, __pyx_n_s_primal, __pyx_n_s_dual, __pyx_n_s_regul, __pyx_n_s_gap, __pyx_n_s_it, __pyx_n_s_ii, __pyx_n_s_i, __pyx_n_s_has_callback, __pyx_n_s_t, __pyx_n_s_sqnorms, __pyx_n_s_w, __pyx_n_s_dcoef, __pyx_n_s_v_data, __pyx_n_s_v, __pyx_n_s_sindices, __pyx_n_s_data, __pyx_n_s_indices, __pyx_n_s_n_nz, __pyx_n_s_ret); if (unlikely(!__pyx_tuple__7)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 163; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_tuple__7);
  __Pyx_GIVEREF(__pyx_tuple__7);
  __pyx_codeobj__8 = (PyObject*)__Pyx_PyCode_New(14, 0, 37, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__7, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_Users_mblondel_Desktop_projects, __pyx_n_s_prox_sdca_fit, 163, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__8)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 163; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
 ...
 *                    np.ndarray[double, ndim=1]y,
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_9lightning_4impl_14prox_sdca_fast_1_prox_sdca_fit, NULL, __pyx_n_s_lightning_impl_prox_sdca_fast); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 163; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_prox_sdca_fit, __pyx_t_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 163; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
