/* Generated by Cython 0.20.1 on Thu Nov 27 00:06:18 2014 */
...
static PyObject *__pyx_f_9lightning_4impl_14prox_sdca_fast__solve_subproblem(double *, int *, int, double, double *, double *, double *, int, double, double, double, double, double *, double *, double *); /*proto*/
...
static PyObject *__pyx_f_9lightning_4impl_14prox_sdca_fast__solve_subproblem(double *__pyx_v_data, int *__pyx_v_indices, int __pyx_v_n_nz, double __pyx_v_y, double *__pyx_v_w, double *__pyx_v_v, double *__pyx_v_dcoef, int __pyx_v_loss_func, double __pyx_v_sqnorm, double __pyx_v_scale, double __pyx_v_sigma, double __pyx_v_gamma, double *__pyx_v_primal, double *__pyx_v_dual, double *__pyx_v_regul) {
  ...
  /* "lightning/impl/prox_sdca_fast.pyx":123
 ...
 */
  ...
  /* "lightning/impl/prox_sdca_fast.pyx":151
 *         dual[0] += y * update
 * 
 ...
 */
    ...
    /* "lightning/impl/prox_sdca_fast.pyx":149
 *         update = max(0.0, update)
 *         update = y * update - dcoef_old
 *         dual[0] += y * update             # <<<<<<<<<<<<<<
 * 
 ...
 *         elif margin > gamma:
 */
    __pyx_t_5 = ((__pyx_v_margin < 0.0) != 0);
    if (__pyx_t_5) {
 ...
 *         else:
 */
    __pyx_t_5 = ((__pyx_v_margin > __pyx_v_gamma) != 0);
    if (__pyx_t_5) {
 ...
 */
      __pyx_v_loss = (__pyx_v_margin - (0.5 * __pyx_v_gamma));
      goto __pyx_L3;
    }
    /*else*/ {

      /* "lightning/impl/prox_sdca_fast.pyx":159
 *             loss = margin - 0.5 * gamma
 *         else:
 *             loss = 0.5 / gamma * margin * margin             # <<<<<<<<<<<<<<
 * 
 ...
 */
      __pyx_v_loss = (((0.5 / __pyx_v_gamma) * __pyx_v_margin) * __pyx_v_margin);
    }
    __pyx_L3:;
 ...
 *         update = min(1.0, update)
 */
    __pyx_v_update = ((__pyx_v_margin - ((__pyx_v_gamma * __pyx_v_dcoef_old) * __pyx_v_y)) / ((__pyx_v_sqnorm * __pyx_v_scale) + __pyx_v_gamma));

    /* "lightning/impl/prox_sdca_fast.pyx":162
 * 
 *         update = (margin - gamma * dcoef_old * y) / (sqnorm * scale + gamma)
 *         update += dcoef_old * y             # <<<<<<<<<<<<<<
 *         update = min(1.0, update)
 ...
 */
    ...
    /* "lightning/impl/prox_sdca_fast.pyx":164
 *         update += dcoef_old * y
 *         update = min(1.0, update)
 *         update = max(0.0, update)             # <<<<<<<<<<<<<<
 *         update = y * update - dcoef_old
 ...
 */
    ...
    /* "lightning/impl/prox_sdca_fast.pyx":165
 *         update = min(1.0, update)
 *         update = max(0.0, update)
 *         update = y * update - dcoef_old             # <<<<<<<<<<<<<<
 *         dual[0] += y * update
 ...
 */
    ...
    /* "lightning/impl/prox_sdca_fast.pyx":166
 *         update = max(0.0, update)
 *         update = y * update - dcoef_old
 *         dual[0] += y * update             # <<<<<<<<<<<<<<
 *         dual[0] -= gamma * dcoef_old * update
 ...
 */
    ...
    /* "lightning/impl/prox_sdca_fast.pyx":167
 *         update = y * update - dcoef_old
 *         dual[0] += y * update
 *         dual[0] -= gamma * dcoef_old * update             # <<<<<<<<<<<<<<
 *         dual[0] -= 0.5 * gamma * update * update
 ...
 */
    ...
    /* "lightning/impl/prox_sdca_fast.pyx":168
 *         dual[0] += y * update
 *         dual[0] -= gamma * dcoef_old * update
 *         dual[0] -= 0.5 * gamma * update * update             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "lightning/impl/prox_sdca_fast.pyx":172
 *     # Use accumulated loss rather than true primal objective value, which is
 ...
 */
  ...
  /* "lightning/impl/prox_sdca_fast.pyx":174
 *     primal[0] += loss
 * 
 *     if update != 0:             # <<<<<<<<<<<<<<
 *         dcoef[0] += update
 ...
 */
    ...
    if (__pyx_t_5) {
      ...
      /* "lightning/impl/prox_sdca_fast.pyx":177
 *         dcoef[0] += update
 *         if sigma > 0:
 *             _add_elastic(data, indices, n_nz, w, v, update * scale, regul,             # <<<<<<<<<<<<<<
 *                          sigma)
 *         else:
 */
      __pyx_t_6 = __pyx_f_9lightning_4impl_14prox_sdca_fast__add_elastic(__pyx_v_data, __pyx_v_indices, __pyx_v_n_nz, __pyx_v_w, __pyx_v_v, (__pyx_v_update * __pyx_v_scale), __pyx_v_regul, __pyx_v_sigma); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 177; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    ...
    /*else*/ {
      ...
      /* "lightning/impl/prox_sdca_fast.pyx":180
 *                          sigma)
 *         else:
 ...
 * 
 */
      __pyx_t_6 = __pyx_f_9lightning_4impl_14prox_sdca_fast__add_l2(__pyx_v_data, __pyx_v_indices, __pyx_v_n_nz, __pyx_v_w, (__pyx_v_update * __pyx_v_scale), __pyx_v_regul); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 180; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_6);
      __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
    }
    __pyx_L5:;
...
/* "lightning/impl/prox_sdca_fast.pyx":183
 * 
 * 
...
static PyObject *__pyx_pw_9lightning_4impl_14prox_sdca_fast_1_prox_sdca_fit(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("_prox_sdca_fit (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_X)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("_prox_sdca_fit", 1, 15, 15, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 183; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_y)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_prox_sdca_fit", 1, 15, 15, 2); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 183; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_coef)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_prox_sdca_fit", 1, 15, 15, 3); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 183; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  4:
        if (likely((values[4] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_dual_coef)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_prox_sdca_fit", 1, 15, 15, 4); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 183; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  5:
        if (likely((values[5] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_alpha1)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_prox_sdca_fit", 1, 15, 15, 5); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 183; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  6:
        if (likely((values[6] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_alpha2)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_prox_sdca_fit", 1, 15, 15, 6); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 183; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  7:
        if (likely((values[7] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_loss_func)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_prox_sdca_fit", 1, 15, 15, 7); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 183; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  8:
        if (likely((values[8] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_gamma)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_prox_sdca_fit", 1, 15, 15, 8); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 183; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  9:
        if (likely((values[9] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_max_iter)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_prox_sdca_fit", 1, 15, 15, 9); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 183; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case 10:
        if (likely((values[10] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_tol)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_prox_sdca_fit", 1, 15, 15, 10); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 183; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case 11:
        if (likely((values[11] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_callback)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_prox_sdca_fit", 1, 15, 15, 11); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 183; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case 12:
        if (likely((values[12] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_n_calls)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_prox_sdca_fit", 1, 15, 15, 12); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 183; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case 13:
        if (likely((values[13] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_verbose)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_prox_sdca_fit", 1, 15, 15, 13); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 183; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case 14:
        if (likely((values[14] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_rng)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_prox_sdca_fit", 1, 15, 15, 14); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 183; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "_prox_sdca_fit") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 183; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    ...
    __pyx_v_alpha1 = __pyx_PyFloat_AsDouble(values[5]); if (unlikely((__pyx_v_alpha1 == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 188; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_alpha2 = __pyx_PyFloat_AsDouble(values[6]); if (unlikely((__pyx_v_alpha2 == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 189; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_loss_func = __Pyx_PyInt_As_int(values[7]); if (unlikely((__pyx_v_loss_func == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 190; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_gamma = __pyx_PyFloat_AsDouble(values[8]); if (unlikely((__pyx_v_gamma == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 191; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_max_iter = __Pyx_PyInt_As_int(values[9]); if (unlikely((__pyx_v_max_iter == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 192; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_tol = __pyx_PyFloat_AsDouble(values[10]); if (unlikely((__pyx_v_tol == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 193; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_callback = values[11];
    __pyx_v_n_calls = __Pyx_PyInt_As_int(values[12]); if (unlikely((__pyx_v_n_calls == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 195; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_verbose = __Pyx_PyInt_As_int(values[13]); if (unlikely((__pyx_v_verbose == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 196; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_rng = values[14];
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("_prox_sdca_fit", 1, 15, 15, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 183; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  __Pyx_AddTraceback("lightning.impl.prox_sdca_fast._prox_sdca_fit", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_X), __pyx_ptype_9lightning_4impl_12dataset_fast_RowDataset, 1, "X", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 184; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_coef), __pyx_ptype_5numpy_ndarray, 1, "coef", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 186; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_dual_coef), __pyx_ptype_5numpy_ndarray, 1, "dual_coef", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 187; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_r = __pyx_pf_9lightning_4impl_14prox_sdca_fast__prox_sdca_fit(__pyx_self, __pyx_v_self, __pyx_v_X, __pyx_v_y, __pyx_v_coef, __pyx_v_dual_coef, __pyx_v_alpha1, __pyx_v_alpha2, __pyx_v_loss_func, __pyx_v_gamma, __pyx_v_max_iter, __pyx_v_tol, __pyx_v_callback, __pyx_v_n_calls, __pyx_v_verbose, __pyx_v_rng);
...
static PyObject *__pyx_pf_9lightning_4impl_14prox_sdca_fast__prox_sdca_fit(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_self, struct __pyx_obj_9lightning_4impl_12dataset_fast_RowDataset *__pyx_v_X, PyArrayObject *__pyx_v_y, PyArrayObject *__pyx_v_coef, PyArrayObject *__pyx_v_dual_coef, double __pyx_v_alpha1, double __pyx_v_alpha2, int __pyx_v_loss_func, double __pyx_v_gamma, int __pyx_v_max_iter, double __pyx_v_tol, PyObject *__pyx_v_callback, int __pyx_v_n_calls, int __pyx_v_verbose, PyObject *__pyx_v_rng) {
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_y.rcbuffer->pybuffer, (PyObject*)__pyx_v_y, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 183; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_pybuffernd_y.diminfo[0].strides = __pyx_pybuffernd_y.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_y.diminfo[0].shape = __pyx_pybuffernd_y.rcbuffer->pybuffer.shape[0];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_coef.rcbuffer->pybuffer, (PyObject*)__pyx_v_coef, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 183; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_dual_coef.rcbuffer->pybuffer, (PyObject*)__pyx_v_dual_coef, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 183; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
 ...
 */
  ...
  /* "lightning/impl/prox_sdca_fast.pyx":200
 * 
 *     cdef int n_samples = X.get_n_samples()
 *     cdef int n_features = X.get_n_features()             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "lightning/impl/prox_sdca_fast.pyx":205
 ...
 */
  ...
  __pyx_t_2 = __Pyx_PyInt_From_int(__pyx_v_n_samples); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 210; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
 ...
 *     # Pointers
 */
  __pyx_t_6 = __pyx_f_9lightning_4impl_14prox_sdca_fast__sqnorms(__pyx_v_X, ((PyArrayObject *)__pyx_v_sqnorms)); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 211; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_6);
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
 ...
 */
  ...
  /* "lightning/impl/prox_sdca_fast.pyx":215
 *     # Pointers
 *     cdef double* w = <double*>coef.data
 *     cdef double* dcoef = <double*>dual_coef.data             # <<<<<<<<<<<<<<
 *     cdef np.ndarray[double, ndim=1] v_data
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_6);
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_6, __pyx_n_s_zeros); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 217; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  __pyx_t_6 = __Pyx_PyInt_From_int(__pyx_v_n_features); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 217; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_6);
  ...
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_float64); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 217; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  if (PyDict_SetItem(__pyx_t_6, __pyx_n_s_dtype, __pyx_t_5) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 217; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_5 = __Pyx_PyObject_Call(__pyx_t_2, __pyx_t_4, __pyx_t_6); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 217; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_6 = __Pyx_PyObject_GetAttrStr(__pyx_t_5, __pyx_n_s_arange); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 220; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_6);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_5 = __Pyx_PyInt_From_int(__pyx_v_n_samples); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 220; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_int32); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 220; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  if (PyDict_SetItem(__pyx_t_5, __pyx_n_s_dtype, __pyx_t_3) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 220; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = __Pyx_PyObject_Call(__pyx_t_6, __pyx_t_4, __pyx_t_5); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 220; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
 ...
 */
    __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_v_rng, __pyx_n_s_shuffle); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 241; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_3);
 ...
 */
        ...
        __pyx_t_5 = __Pyx_PyObject_Call(__pyx_v_callback, __pyx_t_4, NULL); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 258; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_5);
        __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
 ...
 */
        ...
        if (__pyx_t_1) {
          ...
          /* "lightning/impl/prox_sdca_fast.pyx":260
 *                 ret = callback(self)
 *                 if ret is not None:
 *                     break             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      /* "lightning/impl/prox_sdca_fast.pyx":262
 *                     break
 * 
 *             t += 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "lightning/impl/prox_sdca_fast.pyx":266
 *         # end for ii in xrange(n_samples)
 * 
 ...
 */
    ...
    /* "lightning/impl/prox_sdca_fast.pyx":267
 * 
 *         gap = (primal - dual) / n_samples + alpha2 * regul
 *         gap = fabs(gap)             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "lightning/impl/prox_sdca_fast.pyx":269
 *         gap = fabs(gap)
 * 
 *         if verbose:             # <<<<<<<<<<<<<<
 *             print "iter", it + 1, gap
 ...
 */
    ...
    if (__pyx_t_1) {
      ...
      /* "lightning/impl/prox_sdca_fast.pyx":270
 * 
 *         if verbose:
 *             print "iter", it + 1, gap             # <<<<<<<<<<<<<<
 * 
 *         if gap <= tol:
 */
      __pyx_t_5 = __Pyx_PyInt_From_long((__pyx_v_it + 1)); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 270; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_5);
      __pyx_t_4 = PyFloat_FromDouble(__pyx_v_gap); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 270; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_4);
      ...
      __pyx_t_5 = 0;
      __pyx_t_4 = 0;
      if (__Pyx_Print(0, __pyx_t_3, 1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 270; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
      goto __pyx_L11;
    }
    __pyx_L11:;

    /* "lightning/impl/prox_sdca_fast.pyx":272
 *             print "iter", it + 1, gap
 * 
 *         if gap <= tol:             # <<<<<<<<<<<<<<
 *             if verbose:
 ...
 */
    ...
    if (__pyx_t_1) {
      ...
      /* "lightning/impl/prox_sdca_fast.pyx":273
 * 
 *         if gap <= tol:
 *             if verbose:             # <<<<<<<<<<<<<<
 *                 print "Converged"
 ...
 */
      ...
      if (__pyx_t_1) {
        ...
        /* "lightning/impl/prox_sdca_fast.pyx":274
 *         if gap <= tol:
 *             if verbose:
 *                 print "Converged"             # <<<<<<<<<<<<<<
 *             break
 * 
 */
        if (__Pyx_PrintOne(0, __pyx_n_s_Converged) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 274; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        goto __pyx_L13;
      }
      __pyx_L13:;

      /* "lightning/impl/prox_sdca_fast.pyx":275
 *             if verbose:
 *                 print "Converged"
 *             break             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "lightning/impl/prox_sdca_fast.pyx":279
 *     # for it in xrange(max_iter)
 * 
 *     for i in xrange(n_samples):             # <<<<<<<<<<<<<<
 *         dcoef[i] *= scale
 */
  ...
  for (__pyx_t_14 = 0; __pyx_t_14 < __pyx_t_8; __pyx_t_14+=1) {
    ...
    /* "lightning/impl/prox_sdca_fast.pyx":280
 * 
 *     for i in xrange(n_samples):
 *         dcoef[i] *= scale             # <<<<<<<<<<<<<<
 */
 ...
 *                    np.ndarray[double, ndim=1]y,
 */
  __pyx_tuple__7 = PyTuple_Pack(38, __pyx_n_s_self, __pyx_n_s_X, __pyx_n_s_y, __pyx_n_s_coef, __pyx_n_s_dual_coef, __pyx_n_s_alpha1, __pyx_n_s_alpha2, __pyx_n_s_loss_func, __pyx_n_s_gamma, __pyx_n_s_max_iter, __pyx_n_s_tol, __pyx_n_s_callback, __pyx_n_s_n_calls, __pyx_n_s_verbose, __pyx_n_s_rng, __pyx_n_s_n_samples, __pyx_n_s_n_features, __pyx_n_s_sigma, __pyx_n_s_scale, __pyx_n_s_primal, __pyx_n_s_dual, __pyx_n_s_regul, __pyx_n_s_gap, __pyx_n_s_it, __pyx_n_s_ii, __pyx_n_s_i, __pyx_n_s_has_callback, __pyx_n_s_t, __pyx_n_s_sqnorms, __pyx_n_s_w, __pyx_n_s_dcoef, __pyx_n_s_v_data, __pyx_n_s_v, __pyx_n_s_sindices, __pyx_n_s_data, __pyx_n_s_indices, __pyx_n_s_n_nz, __pyx_n_s_ret); if (unlikely(!__pyx_tuple__7)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 183; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_tuple__7);
  __Pyx_GIVEREF(__pyx_tuple__7);
  __pyx_codeobj__8 = (PyObject*)__Pyx_PyCode_New(15, 0, 38, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__7, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_Users_mblondel_Desktop_projects, __pyx_n_s_prox_sdca_fit, 183, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__8)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 183; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
 ...
 *                    np.ndarray[double, ndim=1]y,
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_9lightning_4impl_14prox_sdca_fast_1_prox_sdca_fit, NULL, __pyx_n_s_lightning_impl_prox_sdca_fast); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 183; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_prox_sdca_fit, __pyx_t_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 183; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
