...
struct __pyx_vtabstruct_9lightning_4impl_8sgd_fast_LossFunction {
  double (*loss)(struct __pyx_obj_9lightning_4impl_8sgd_fast_LossFunction *, double, double, int, int __pyx_skip_dispatch);
  double (*get_update)(struct __pyx_obj_9lightning_4impl_8sgd_fast_LossFunction *, double, double, int, int __pyx_skip_dispatch);
};
 ...
 */
    ...
    (__pyx_v_g[__pyx_v_i]) = (-((struct __pyx_vtabstruct_9lightning_4impl_8sgd_fast_LossFunction *)__pyx_v_loss->__pyx_vtab)->get_update(__pyx_v_loss, __pyx_v_y_pred, (*__Pyx_BufPtrStrided1d(double *, __pyx_pybuffernd_y.rcbuffer->pybuffer.buf, __pyx_t_22, __pyx_pybuffernd_y.diminfo[0].strides)), __pyx_v_i, 0));
 ...
 */
      ...
      (__pyx_v_g[__pyx_v_i]) = (-((struct __pyx_vtabstruct_9lightning_4impl_8sgd_fast_LossFunction *)__pyx_v_loss->__pyx_vtab)->get_update(__pyx_v_loss, __pyx_v_y_pred, (*__Pyx_BufPtrStrided1d(double *, __pyx_pybuffernd_y.rcbuffer->pybuffer.buf, __pyx_t_25, __pyx_pybuffernd_y.diminfo[0].strides)), __pyx_v_i, 0));
