...
class AdaGradClassifier(BaseClassifier, ClassifierMixin):
    ...
    def __init__(self, eta=1.0, alpha=1.0, l1_ratio=0, n_iter=10, random_state=None):
        self.eta = eta
        self.alpha = alpha
    ...
    def fit(self, X, y):
        ...
        for i in xrange(n_vectors):
            _adagrad_fit(ds, y, self.coef_[i], g_sum[i], g_norms[i], self.eta,
                         delta, alpha1, alpha2, self.n_iter, rng)
