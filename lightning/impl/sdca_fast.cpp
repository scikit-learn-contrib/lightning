/* Generated by Cython 0.20.1 on Tue Jan  6 22:09:06 2015 */
...
static char __pyx_k_Users_mblondel_Desktop_projects[] = "/Users/mblondel/Desktop/projects/lightning/lightning/impl/sdca_fast.pyx";
...
static PyMethodDef __pyx_mdef_9lightning_4impl_9sdca_fast_1_prox_sdca_fit = {__Pyx_NAMESTR("_prox_sdca_fit"), (PyCFunction)__pyx_pw_9lightning_4impl_9sdca_fast_1_prox_sdca_fit, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(0)};
...
static PyObject *__pyx_pf_9lightning_4impl_9sdca_fast__prox_sdca_fit(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_self, struct __pyx_obj_9lightning_4impl_12dataset_fast_RowDataset *__pyx_v_X, PyArrayObject *__pyx_v_y, PyArrayObject *__pyx_v_coef, PyArrayObject *__pyx_v_dual_coef, double __pyx_v_alpha1, double __pyx_v_alpha2, int __pyx_v_loss_func, double __pyx_v_gamma, int __pyx_v_max_iter, double __pyx_v_tol, PyObject *__pyx_v_callback, int __pyx_v_n_calls, int __pyx_v_verbose, PyObject *__pyx_v_rng) {
  ...
  /* "lightning/impl/sdca_fast.pyx":212
 *                    rng):
 * 
 *     cdef int n_samples = X.get_n_samples()             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "lightning/impl/sdca_fast.pyx":218
 ...
 */
  ...
  /* "lightning/impl/sdca_fast.pyx":223
 ...
 *     # Pointers
 */
  __pyx_t_6 = __pyx_f_9lightning_4impl_9sdca_fast__sqnorms(__pyx_v_X, ((PyArrayObject *)__pyx_v_sqnorms)); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 224; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_6);
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;

  /* "lightning/impl/sdca_fast.pyx":227
 * 
 *     # Pointers
 ...
 */
  ...
  /* "lightning/impl/sdca_fast.pyx":230
 *     cdef double* dcoef = <double*>dual_coef.data
 *     cdef np.ndarray[double, ndim=1] v_data
 *     v_data = np.zeros(n_features, dtype=np.float64)             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "lightning/impl/sdca_fast.pyx":233
 *     cdef double* v = <double*>v_data.data
 *     cdef np.ndarray[int, ndim=1] sindices
 *     sindices = np.arange(n_samples, dtype=np.int32)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "lightning/impl/sdca_fast.pyx":240
 *     cdef int n_nz
 * 
 ...
 */
  ...
  /*else*/ {
    ...
    /* "lightning/impl/sdca_fast.pyx":243
 *         sigma = alpha1 / alpha2
 *     else:  # L2-only case
 *         sigma = 0             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "lightning/impl/sdca_fast.pyx":248
 * 
 *     dual = 0
 *     regul = 0             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  for (__pyx_t_14 = 0; __pyx_t_14 < __pyx_t_8; __pyx_t_14+=1) {
    ...
    /* "lightning/impl/sdca_fast.pyx":252
 *     t = 0
 *     for it in xrange(max_iter):
 *         primal = 0             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "lightning/impl/sdca_fast.pyx":254
 *         primal = 0
 * 
 *         rng.shuffle(sindices)             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    for (__pyx_t_16 = 0; __pyx_t_16 < __pyx_t_15; __pyx_t_16+=1) {
      ...
      /* "lightning/impl/sdca_fast.pyx":258
 *         for ii in xrange(n_samples):
 * 
 *             i = sindices[ii]             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      if (__pyx_t_1) {
        ...
        /* "lightning/impl/sdca_fast.pyx":261
 * 
 *             if sqnorms[i] == 0:
 *                 continue             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      /* "lightning/impl/sdca_fast.pyx":264
 * 
 *             # Retrieve row.
 *             X.get_row_ptr(i, &indices, &data, &n_nz)             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      /* "lightning/impl/sdca_fast.pyx":267
 * 
 *             _solve_subproblem(data, indices, n_nz, y[i], w, v, dcoef + i,
 *                               loss_func, sqnorms[i], scale, sigma, gamma,             # <<<<<<<<<<<<<<
 *                               &primal, &dual, &regul)
 ...
 *                               &primal, &dual, &regul)
 */
      __pyx_t_4 = __pyx_f_9lightning_4impl_9sdca_fast__solve_subproblem(__pyx_v_data, __pyx_v_indices, __pyx_v_n_nz, (*__Pyx_BufPtrStrided1d(double *, __pyx_pybuffernd_y.rcbuffer->pybuffer.buf, __pyx_t_19, __pyx_pybuffernd_y.diminfo[0].strides)), __pyx_v_w, __pyx_v_v, (__pyx_v_dcoef + __pyx_v_i), __pyx_v_loss_func, (*__Pyx_BufPtrCContig1d(double *, __pyx_pybuffernd_sqnorms.rcbuffer->pybuffer.buf, __pyx_t_20, __pyx_pybuffernd_sqnorms.diminfo[0].strides)), __pyx_v_scale, __pyx_v_sigma, __pyx_v_gamma, (&__pyx_v_primal), (&__pyx_v_dual), (&__pyx_v_regul)); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 266; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_4);
      __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
 ...
 */
    ...
    /* "lightning/impl/sdca_fast.pyx":285
 *             print "iter", it + 1, gap
 * 
 *         if gap <= tol:             # <<<<<<<<<<<<<<
 *             if verbose:
...
#endif
{
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4(__Pyx_NAMESTR("sdca_fast"), __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
