    ...
    def _fit(self, X, Y):
        ...
        for i in xrange(n_vectors):
            ...
            _sag_fit(self, ds, y, self.coef_[i], self.coef_scale_[i:], grad[i],
                     self.eta, self.alpha, beta, loss, penalty,
...
class SAGClassifier(BaseClassifier, _BaseSAG):
    ...
    def __init__(self, eta=1.0, alpha=1.0, loss="smooth_hinge", gamma=1.0,
                 max_iter=10, n_inner=1.0, tol=1e-3, verbose=0, callback=None,
                 random_state=None):
        self.eta = eta
        self.alpha = alpha
        self.loss = loss
...
class SAGARegressor(SAGRegressor):
    ...
    def __init__(self, eta=1.0, alpha=1.0, beta=0.0, loss="smooth_hinge",
            ...
            super(SAGARegressor, self).__init__(
                eta=eta, alpha=alpha, loss=loss, gamma=1.0, max_iter=max_iter,
