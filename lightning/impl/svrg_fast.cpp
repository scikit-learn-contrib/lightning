/* Generated by Cython 0.20.1 on Fri Jan  2 14:17:47 2015 */
 ...
 */
      __pyx_t_7 = __Pyx_PyInt_From_long((__pyx_v_it + 1)); if (unlikely(!__pyx_t_7)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 118; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_7);
      __pyx_t_8 = PyFloat_FromDouble(__pyx_v_violation_ratio); if (unlikely(!__pyx_t_8)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 118; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      ...
      __pyx_t_7 = 0;
      __pyx_t_8 = 0;
      if (__Pyx_Print(0, __pyx_t_9, 1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 118; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 * 
 */
        if (__Pyx_PrintOne(0, __pyx_n_s_Converged) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 122; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        goto __pyx_L14;
      }
      __pyx_L14:;
 ...
 */
        ...
        (__pyx_v_w[__pyx_t_13]) = ((__pyx_v_w[__pyx_t_13]) - ((__pyx_v_eta_avg / __pyx_v_w_scale) * (__pyx_v_fg[__pyx_v_j])));
      }
 ...
 *                     w[j] *= w_scale
 */
      __pyx_t_6 = ((__pyx_v_w_scale < 1e-9) != 0);
      if (__pyx_t_6) {

        /* "lightning/impl/svrg_fast.pyx":149
 *             # Take care of possible overflows.
 *             if w_scale < 1e-9:
 *                 for j in xrange(n_features):             # <<<<<<<<<<<<<<
 *                     w[j] *= w_scale
 ...
 */
          __pyx_t_13 = __pyx_v_j;
          (__pyx_v_w[__pyx_t_13]) = ((__pyx_v_w[__pyx_t_13]) * __pyx_v_w_scale);
        }

        /* "lightning/impl/svrg_fast.pyx":151
 *                 for j in xrange(n_features):
 *                     w[j] *= w_scale
 *                 w_scale = 1.0             # <<<<<<<<<<<<<<
 */
 ...
 *               np.ndarray[double, ndim=1]y,
 */
  __pyx_tuple__7 = PyTuple_Pack(34, __pyx_n_s_self, __pyx_n_s_X, __pyx_n_s_y, __pyx_n_s_coef, __pyx_n_s_full_grad, __pyx_n_s_grad, __pyx_n_s_eta, __pyx_n_s_alpha, __pyx_n_s_loss, __pyx_n_s_max_iter, __pyx_n_s_n_inner, __pyx_n_s_tol, __pyx_n_s_verbose, __pyx_n_s_rng, __pyx_n_s_n_samples, __pyx_n_s_n_features, __pyx_n_s_i, __pyx_n_s_j, __pyx_n_s_it, __pyx_n_s_t, __pyx_n_s_y_pred, __pyx_n_s_scale, __pyx_n_s_violation, __pyx_n_s_violation_init, __pyx_n_s_violation_ratio, __pyx_n_s_eta_avg, __pyx_n_s_eta_alpha, __pyx_n_s_w_scale, __pyx_n_s_data, __pyx_n_s_indices, __pyx_n_s_n_nz, __pyx_n_s_w, __pyx_n_s_fg, __pyx_n_s_g); if (unlikely(!__pyx_tuple__7)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 48; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_tuple__7);
  __Pyx_GIVEREF(__pyx_tuple__7);
  __pyx_codeobj__8 = (PyObject*)__Pyx_PyCode_New(14, 0, 34, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__7, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_Users_mblondel_Desktop_projects, __pyx_n_s_svrg_fit, 48, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__8)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 48; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
